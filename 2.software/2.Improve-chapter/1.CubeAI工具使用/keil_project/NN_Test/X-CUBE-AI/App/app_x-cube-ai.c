...
AI_ALIGNED(32)
static uint8_t pool0[AI_NETWORK_SINE_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_NETWORK_SINE_MODEL_NAME,
        .config = AI_NETWORK_SINE_DATA_CONFIG,
        .ai_get_report = ai_network_sine_get_report,
        .ai_create = ai_network_sine_create,
        .ai_destroy = ai_network_sine_destroy,
        .ai_get_error = ai_network_sine_get_error,
        .ai_init = ai_network_sine_init,
        .ai_run = ai_network_sine_run,
        .ai_forward = ai_network_sine_forward,
        .ai_data_params_get = ai_network_sine_data_params_get,
