...
AI_ALIGNED(32)
static uint8_t pool0[AI_SINE_CALCU_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_SINE_CALCU_MODEL_NAME,
        .config = AI_SINE_CALCU_DATA_CONFIG,
        .ai_get_report = ai_sine_calcu_get_report,
        .ai_create = ai_sine_calcu_create,
        .ai_destroy = ai_sine_calcu_destroy,
        .ai_get_error = ai_sine_calcu_get_error,
        .ai_init = ai_sine_calcu_init,
        .ai_run = ai_sine_calcu_run,
        .ai_forward = ai_sine_calcu_forward,
        .ai_data_params_get = ai_sine_calcu_data_params_get,
