/**
  ...
  ******************************************************************************
  */
#ifndef AI_SINE_CALCU_H
#define AI_SINE_CALCU_H

#include "sine_calcu_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINE_CALCU_MODEL_NAME          "sine_calcu"
#define AI_SINE_CALCU_ORIGIN_MODEL_NAME   "sine_calcu"

/******************************************************************************/
#define AI_SINE_CALCU_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINE_CALCU_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINE_CALCU_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SINE_CALCU_IN_NUM        (1)

AI_DEPRECATED
#define AI_SINE_CALCU_IN \
  ai_sine_calcu_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINE_CALCU_IN_SIZE { \
  AI_SINE_CALCU_IN_1_SIZE, \
}
#define AI_SINE_CALCU_IN_SIZE_BYTES { \
  AI_SINE_CALCU_IN_1_SIZE_BYTES, \
}
#define AI_SINE_CALCU_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_CALCU_IN_1_CHANNEL     (1)
#define AI_SINE_CALCU_IN_1_SIZE        (1)
#define AI_SINE_CALCU_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINE_CALCU_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SINE_CALCU_OUT \
  ai_sine_calcu_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SINE_CALCU_OUT_SIZE { \
  AI_SINE_CALCU_OUT_1_SIZE, \
}
#define AI_SINE_CALCU_OUT_SIZE_BYTES { \
  AI_SINE_CALCU_OUT_1_SIZE_BYTES, \
}
#define AI_SINE_CALCU_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_CALCU_OUT_1_CHANNEL     (1)
#define AI_SINE_CALCU_OUT_1_SIZE        (1)
#define AI_SINE_CALCU_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SINE_CALCU_N_NODES (5)
 ...
 * @ref ai_sine_calcu_create. Both the activations memory buffer 
 ...
 * using @ref ai_sine_calcu_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_calcu_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sine_calcu_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SINE_CALCU_*
 * defines into file @ref sine_calcu.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sine_calcu_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINE_CALCU_H */
