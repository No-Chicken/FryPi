...
#ifndef AI_NETWORK_SINE_H
#define AI_NETWORK_SINE_H
#pragma once

#include "network_sine_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_SINE_MODEL_NAME          "network_sine"
#define AI_NETWORK_SINE_ORIGIN_MODEL_NAME   "sine_calcu"

/******************************************************************************/
#define AI_NETWORK_SINE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_SINE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_SINE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_SINE_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_SINE_IN \
  ai_network_sine_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_SINE_IN_SIZE { \
  AI_NETWORK_SINE_IN_1_SIZE, \
}
#define AI_NETWORK_SINE_IN_SIZE_BYTES { \
  AI_NETWORK_SINE_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_SINE_IN_1_CHANNEL     (1)
#define AI_NETWORK_SINE_IN_1_SIZE        (1)
#define AI_NETWORK_SINE_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_SINE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_SINE_OUT \
  ai_network_sine_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_SINE_OUT_SIZE { \
  AI_NETWORK_SINE_OUT_1_SIZE, \
}
#define AI_NETWORK_SINE_OUT_SIZE_BYTES { \
  AI_NETWORK_SINE_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_SINE_OUT_1_CHANNEL     (1)
#define AI_NETWORK_SINE_OUT_1_SIZE        (1)
#define AI_NETWORK_SINE_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_SINE_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_sine
 ...
 * @ref ai_network_sine_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_sine_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_sine_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_sine_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_SINE_*
 * defines into file @ref network_sine.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_sine_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_SINE_H */
