...
AI_ALIGNED(32)
static uint8_t pool0[AI_GESTURE_CNN_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_GESTURE_CNN_MODEL_NAME,
        .config = AI_GESTURE_CNN_DATA_CONFIG,
        .ai_get_report = ai_gesture_cnn_get_report,
        .ai_create = ai_gesture_cnn_create,
        .ai_destroy = ai_gesture_cnn_destroy,
        .ai_get_error = ai_gesture_cnn_get_error,
        .ai_init = ai_gesture_cnn_init,
        .ai_run = ai_gesture_cnn_run,
        .ai_forward = ai_gesture_cnn_forward,
        .ai_data_params_get = ai_gesture_cnn_data_params_get,
