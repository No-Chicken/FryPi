...
#ifndef AI_GESTURE_CNN_H
#define AI_GESTURE_CNN_H
#pragma once
...
/******************************************************************************/
#define AI_GESTURE_CNN_MODEL_NAME          "gesture_cnn"
#define AI_GESTURE_CNN_ORIGIN_MODEL_NAME   "gesture"

/******************************************************************************/
#define AI_GESTURE_CNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_GESTURE_CNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_GESTURE_CNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_GESTURE_CNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_GESTURE_CNN_IN \
  ai_gesture_cnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_CNN_IN_SIZE { \
  AI_GESTURE_CNN_IN_1_SIZE, \
}
#define AI_GESTURE_CNN_IN_SIZE_BYTES { \
  AI_GESTURE_CNN_IN_1_SIZE_BYTES, \
}
#define AI_GESTURE_CNN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_GESTURE_CNN_IN_1_HEIGHT      (24)
#define AI_GESTURE_CNN_IN_1_WIDTH       (32)
#define AI_GESTURE_CNN_IN_1_CHANNEL     (1)
#define AI_GESTURE_CNN_IN_1_SIZE        (24 * 32 * 1)
#define AI_GESTURE_CNN_IN_1_SIZE_BYTES  (3072)

/******************************************************************************/
#define AI_GESTURE_CNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_GESTURE_CNN_OUT \
  ai_gesture_cnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_GESTURE_CNN_OUT_SIZE { \
  AI_GESTURE_CNN_OUT_1_SIZE, \
}
#define AI_GESTURE_CNN_OUT_SIZE_BYTES { \
  AI_GESTURE_CNN_OUT_1_SIZE_BYTES, \
}
#define AI_GESTURE_CNN_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_GESTURE_CNN_OUT_1_CHANNEL     (6)
#define AI_GESTURE_CNN_OUT_1_SIZE        (6)
#define AI_GESTURE_CNN_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_GESTURE_CNN_N_NODES (12)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup gesture_cnn
 ...
 * @ref ai_gesture_cnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_gesture_cnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_cnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_gesture_cnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_GESTURE_CNN_*
 * defines into file @ref gesture_cnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_gesture_cnn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_GESTURE_CNN_H */
