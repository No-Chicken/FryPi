...
#define AI_MNIST_ORIGIN_MODEL_NAME   "mnist"
...
#define AI_MNIST_IN_1_HEIGHT      (30)
#define AI_MNIST_IN_1_WIDTH       (30)
#define AI_MNIST_IN_1_CHANNEL     (1)
#define AI_MNIST_IN_1_SIZE        (30 * 30 * 1)
#define AI_MNIST_IN_1_SIZE_BYTES  (3600)
